                    ...
                    class="w-full flex items-center flex-col">
                        ...
                        <x-form-auth.form-class>
                            <input type="email" value="{{ $request->email }}" name="email"
                                class="border block w-full rounded-sm border-gray-400 bg-gray-100
                                text-gray-400 text-center"readonly>

                            <label class="mt-2 block text-secondary font-roboto font-medium" for="password">
                                Password
                            </label>
                            <x-input-password placeholder="Insert Password" id="password" type="password"
                            name="password" required />

                            <label class="block text-secondary font-roboto font-medium" for="password_confirmation">
                                Confirm Password
                            </label>
                            <x-input-password placeholder="Insert Password" id="password" type="password"
