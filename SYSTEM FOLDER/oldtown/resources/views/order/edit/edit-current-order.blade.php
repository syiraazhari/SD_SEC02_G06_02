    ...
    <x-body>
        ...
        <x-flex-view>
            ...
            <div class="md:m-10 m-5 flex-grow">
                ...
                <div class="bg-white p-3 font-poppins border border-t-0">
                    ...
                    <div class="p-3">
                        <h3>Status:</h3>
                        <input type="hidden" name="id" value="{{$orderID->customer_id}}">
                        <label for="status" class="block mb-2 text-sm font-medium text-gray-900">
                            Change Status
                        </label>
                        <select name="status" id="status" class="bg-gray-50 border border-gray-300
                        text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary
                        block w-full p-2.5">
                    ...
                    <div class="flex justify-end p-3">
                        <button type="button" data-id="{{ $orderID->customer_id }}"
                            onclick="$('#dataid').val($(this).data('id')); $('#editorder').modal('show');">
                            <h3 class="bg-emerald-500 px-5 text-white py-2 rounded-md
        ...
        <div id="editorder" tabindex="-1" class="hidden">
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                <div>
                    <form action="{{ route('update-current-order',  $orderID->customer_id ) }}" method="POST">
                        @csrf
                        <div class="p-6 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-4 w-14 h-14
                                text-gray-400" viewBox="0 0 24 24" stroke-width="2"
                                    stroke="currentColor" fill="none" stroke-linecap="round"
                                    stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                <path d="M12 3c1.918 0 3.52 1.35 3.91 3.151a4 4 0 0 1 2.09 7.723l0
                                7.126h-12v-7.126a4.002 4.002 0 1 1 2.092 -7.723a3.999 3.999 0
                                0 1 3.908 -3.151z">
                            </path>
                            ...
                            <button data-modal-toggle="popup-modal" type="submit"
                                ...
                                focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium
