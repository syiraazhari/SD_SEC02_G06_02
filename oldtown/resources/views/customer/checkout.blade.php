        ...
        <div class="md:container mx-auto md:p-10">
            ...
            <div class="p-5 pb-0">
                ...
                <div class="pb-3">
                    ...
                    <input type="number" name="customer_table" value="1"
                        class="text-center peer mt-1 block w-full px-3 py-2 bg-white rounded-md text-sm shadow-sm placeholder-slate-400"
                        readonly />
                </div>
                ...
                <div class="grid grid-cols-2 gap-x-5 pb-1">
                    <div>
                        ...
                        <input type="text" name="first_name" id="first_name" placeholder="First Name" required
                            class="peer mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none
                            focus:border-primary focus:ring-1 focus:ring-primary invalid:border-pink-500 invalid:text-pink-600  focus:invalid:border-pink-500 focus:invalid:ring-pink-500" />
                ...
                <button type="submit" class="w-full block bg-primary text-xl font-seoulHangang rounded-sm my-3 p-2">
                    Next </button>
            </div>
    </form>
    <a href="/">
