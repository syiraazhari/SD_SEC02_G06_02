    ...
    <x-body>
        ...
        <x-flex-view>
            ...
            <div class="md:m-10 m-5 flex-grow">
                ...
                <x-breadcrumbs-text Title="Order" subtitle="Current Order" />
                                ...
                                @forelse ($receiveOrder as $order)
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="py-4 px-6">
                                            ...
                                            <a href="/order/current-order/{{ $order->customer_id }}"
                                                class="mx-5 font-medium text-emerald-600 hover:underline">Edit</a>
                                            <button data-id="{{ $order->customer_id }}"
                                                class="font-medium text-red-600 hover:underline"
                                                onclick="$('#dataid').val($(this).data('id')); $('#deleteorder').modal('show');">Delete
                                            </button>
