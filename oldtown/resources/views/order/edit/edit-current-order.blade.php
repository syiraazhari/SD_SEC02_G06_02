            ...
            <div class="md:m-10 m-5 flex-grow">
                ...
                <div class="bg-white p-3 font-poppins border border-t-0">
                    ...
                    <div class="p-3">
                        ...
                        <label for="status" class="block mb-2 text-sm font-medium text-gray-900">Change Status</label>
                        <select name="status" id="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5">
                ...
                <div>
                    <form action="{{ route('update-current-order',  $orderID->customer_id ) }}" method="POST">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Change Status to Completed?</h3>
