<nav class="bg-blackie border-b border-b-blackie p-3 shadow-md" x-data="{ isOpen: false }">
    <div class="flex md:justify-between justify-end py-2">
        ...
        <div class="flex">
            ...
            <button @click="isOpen = !isOpen" class="md:hidden" @click="isOpen = !isOpen">
    ...
    <!-- Mobile Menu -->
    <div class="flex flex-col items-center" x-show="isOpen" x-transition>
        <div class="mb-5">
            <a class="flex items-center px-4 py-2 mt-5 transition-colors duration-300 transform rounded-md  hover:bg-gray-200   hover:text-gray-700"
                href="#">
            ...
            <a class="flex items-center px-4 py-2 mt-5 transition-colors duration-300 transform rounded-md  hover:bg-gray-200   hover:text-gray-700"
                ...
                <span class="mx-4 font-medium">Menu</span>
            </a>
