    ...
    <div class="flex flex-col lg:flex-row">
        ...
        <main class="flex-1 lg:ml-64 mt-5 ">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-5 mx-5 mb-5">
                ...
                <div class="shadow-sm border border-gray-300 rounded-sm p-5">
                    <div>
                        ...
                        <div class="flex justify-end">
                            <i class="fa-solid fa-clipboard-list h-16 text-blue-600"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="shadow-sm border border-gray-300 rounded-sm  p-5">
                    <div>
                        <h3 class="text-lg font-Roboto">Total Menu</h3>
                        <span class="text-xl font-bold font-Roboto">20</span>
                        <div class="flex justify-end">
                            <i class="fa-solid fa-bowl-food h-16 text-green-500"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="shadow-sm border border-gray-300 rounded-sm  p-5">
                    <div>
                        <h3 class="text-lg font-Roboto">Total Staff</h3>
                        <span class="text-xl font-bold font-Roboto">20</span>
                        <div class="flex justify-end">
                            <i class="fa-solid fa-user h-16 text-secondary"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="shadow-sm border border-gray-300 rounded-sm  p-5">
                    <div>
                        <h3 class="text-lg font-Roboto">Total Revenue</h3>
                        <span class="text-xl font-bold font-Roboto">20</span>
                        <div class="flex justify-end">
                            <i class="fa-solid fa-money-bill-trend-up h-16 text-yellow-600"></i>
                        </div>
                    </div>
                </div>
