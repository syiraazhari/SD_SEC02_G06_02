                            ...
                            <div>
                                <div class="my-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input name="birthdate" id="birthdate" datepicker datepicker-orientation="bottom" datepicker-autohide type="text" class="bg-gray-50 border border-slate-800 text-gray-900 sm:text-sm rounded-lg focus:ring-slate-800 focus:border-slate-800 focus:border-2 block w-full pl-10 p-2.5">
                                    </div>
                                </div>
                            </div>
