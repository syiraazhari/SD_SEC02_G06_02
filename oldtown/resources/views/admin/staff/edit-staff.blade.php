                                ...
                                <div class="my-2">
                                    <label class="text-secondary" for="birthdate">Birthdate</label>
                                        <div class="relative">
                                            ...
                                            <input datepicker datepicker-orientation="bottom" datepicker-autohide type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" value="{{ $staff->birthdate }}">
                                        </div>
                                </div>
                            </div>
