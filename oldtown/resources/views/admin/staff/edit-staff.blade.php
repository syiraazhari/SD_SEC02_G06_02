                        ...
                        <div class="col-span-2 border-l px-5">
                                ...
                                <div class="my-2">
                                    <label class="text-secondary" for="birthdate">Birthdate</label>
                                        <div class="relative">
                                            ...
                                            <input name="birthdate" id="birthdate" datepicker datepicker-orientation="bottom" datepicker-autohide type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" value="{{ $staff->birthdate }}">
                                        </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <label class="text-secondary block font-roboto font-medium" for="contact_number">Contact
                                    Number</label>
                                <x-input type="number" placeholder="Contact Number" name='contact_number' id='contact_number'
