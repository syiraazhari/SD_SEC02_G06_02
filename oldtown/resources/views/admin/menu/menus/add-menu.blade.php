                    ...
                    <div class="grid md:grid-cols-3 grid-cols-1 bg-white my-3 rounded-sm border">
                        ...
                        <div class="col-span-2 border-l px-5">
                            ...
                            <div class="grid grid-cols-2 gap-5 mb-3">
                                <div>
                                    <label class="text-secondary block font-roboto font-medium" for="cost_price">
                                        Cost Price
                                    </label>
                                ...
                                <div>
                                    ...
                                    for="selling_price">Selling Price
                                    </label>
                            ...
                            <div>
                                <label class="text-secondary block font-roboto font-medium" for="category">
                                    Category
                                </label>

                                <select id="category_id" name="category_id"
                                    class="block w-full px-4 py-2 mt-2 font-roboto text-slate-800 bg-white
                                    border border-slate-800 rounded-md focus:border-slate-800
