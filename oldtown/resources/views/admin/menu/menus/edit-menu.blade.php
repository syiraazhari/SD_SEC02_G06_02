        ...
        <x-flex-view>
            ...
            <div class="md:m-10 m-5 flex-grow">
                @foreach ($menus as $menu)
                    <div>
                        <h3 class="text-2xl font-poppins">Edit Menu</h3>
                    </div>
                    ...
                    <form action="{{ route('edit-menu', $menu->id) }}" method="POST"
                        ...
                        <div class="grid md:grid-cols-3 grid-cols-1 bg-white my-3 rounded-sm border">
                            ...
                            <div class="place-self-center py-3">
                                <input type="hidden" name="oldImage" value="{{ $menu->menu_images }}">
                            ...
                            <div class="col-span-2 border-l px-5">
                                ...
                                <div>
                                    <div class="my-2">
                                        ...
                                        <x-input type="text" placeholder="Insert Menu Name" name='menu_name'
                                            id='menu_name' value="{{ $menu->menu_name }}" required />
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-5 mb-3">
                                    <div>
                                        ...
                                        for="cost_price">Cost
                                            Price</label>
                                        <x-input placeholder="Cost of Price" name='cost_price' id='cost_price'
                                            max="100" value="{{ $menu->cost_price }}" required />

                                    </div>
                                    <div>
                                        <label class="text-secondary block font-roboto font-medium"
                                            for="selling_price">Selling
                                            Price</label>
                                        <x-input placeholder="Selling Price" name='selling_price'
                                        id='selling_price'
                                            max="100" value="{{ $menu->selling_price }}" required />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select id="category_id" name="category_id"
                                        ...
                                        focus:ring-slate-800  focus:ring-opacity-80 focus:outline-none
                                        focus:ring">
                                ...
                                <div class="my-2">
                                    ...
                                    <textarea name="description" id="description"
                                        ...
                                        focus:ring-slate-800  focus:ring-opacity-80 focus:outline-none
                                        focus:ring"
                                        style="resize: none;" required>{{ $menu->description }}
                                    </textarea>
                                </div>
